...
urlpatterns = [
    ...
    path('meter/create/unit-create/', views.CreateUnitView.as_view(), name='unit-create'),
    path('meter/create/resource-create/', views.CreateResourceView.as_view(), name='resource-create'),
